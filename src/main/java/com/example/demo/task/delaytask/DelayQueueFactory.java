...
public class DelayQueueFactory {
     ...
     * @throws Exception
     */
    public static RedisConcurrentDelayQueue getRedisConcurrentDelayQueue(String queueName, long delay, boolean autoAck) {
        return new RedisConcurrentDelayQueue(queueName, delay, autoAck);
    }

...
import com.example.demo.util.HttpLogHelper;
import com.example.demo.util.HttpUtils;
import com.example.demo.wrapper.ReadableHttpRequestWrapper;
import com.example.demo.wrapper.ReadableHttpResponseWrapper;
...
public class StreamReadableFilter extends OncePerRequestFilter {
    ...
    private String getResponseHeader(ReadableHttpResponseWrapper responseWrapper) {
        StringBuilder header = new StringBuilder();
        responseWrapper.getHeaderNames().forEach(key -> header.append(String.format("%s = %s; ", key, responseWrapper.getHeader(key))));
        return header.toString();
    }
}